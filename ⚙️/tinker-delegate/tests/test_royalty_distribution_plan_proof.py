...
class RoyaltyDistributionPlanProofTest(unittest.TestCase):
    def test_plan_calldata_executes_and_conserves(self):
        ...
        self.assertTrue(summary["deterministic_reservation_id_verified"])
        self.assertTrue(summary["active_prefunding_verified_before_handoff"])
        self.assertTrue(summary["no_value_settle_reserved_calldata_verified"])
        self.assertTrue(summary["permanent_consumed_reconciliation_verified"])
